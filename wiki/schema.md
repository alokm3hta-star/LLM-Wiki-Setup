...
**MANDATORY for all `trm-pscd-core` pages** — all 4 fields required; no page in this cluster may omit this block. Inject immediately following the `Sources` array field:
