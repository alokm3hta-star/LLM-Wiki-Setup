...
COPYRIGHT_PATTERNS = [
    ...
    r'Generated on:\s*[^\n]+',
    # Repeated document title footers: a line that is nothing but the word
    # "Content" (PDF nav-link artefact). Anchored to line start and excludes
    # markdown headings so it never truncates a heading/sentence that merely
    # ends in the word "Content" (e.g. "## Highlighting Backend-Dependent Content").
    r'^(?!#)\s*Content\s*$',
]
